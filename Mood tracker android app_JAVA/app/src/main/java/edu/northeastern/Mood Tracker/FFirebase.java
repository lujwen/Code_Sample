...
public class FFirebase extends FirebaseMessagingService {
    ...
    public void onCreate() {
        ...
        userDB.child("FUsers").child(userId).get().addOnCompleteListener(task -> {
...
//        });
    ...
    public void onNewToken(@NonNull String token) {
        ...
        userDB.child("FUsers").child(user.userDeviceID).setValue(user);
    }
